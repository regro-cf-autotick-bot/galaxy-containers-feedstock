...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/galaxy-containers-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14403&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/galaxy-containers-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `galaxy-containers` can be installed with:

```
conda install galaxy-containers
```

It is possible to list all of the versions of `galaxy-containers` available on your platform with:
